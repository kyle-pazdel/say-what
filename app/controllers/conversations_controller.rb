class ConversationsController < ApplicationController
  ...
  def index
    @users = User.all
    @conversations = Conversation.all.map { |conversation| conversation if conversation&.messages&.last }
    @conversations = @conversations.sort_by { |conversation| conversation&.messages&.last&.created_at.to_i }
